...
<!----------------------------------------Categories---------------------------------------->
	...
	<div class='container' id='categories'>
		<h2>CATEGORIES</h2>
		<div class="row">
			<div class="col-md-3"><div class="category-card" style="background-image: url(data/landscape-full.jpg);"><p>landscape</p></div></div>
			<div class="col-md-3"><div class="category-card" style="background-image: url(data/abstract-full.jpg);"><p>abstract</p></div></div>
			<div class="col-md-3"><div class="category-card" style="background-image: url(data/black-and-white.jpg);"><p>blackwhite</p></div></div>
			<div class="col-md-3"><div class="category-card" style="background-image: url(data/portrait-full.jpg);"><p>portrait</p></div></div>
		</div>
	</div>
...
<!----------------------------------------Artist---------------------------------------->
	...
	<div class="container-fluid" id="artist">
		<div class="container content">
			...
			<div class="morebtn button"><a href="#">More</a></div>
		</div>
	</div>
	...
	<div class='container' id='choise'>
		...
		<div class="container picture">
			<div class="overlay">
				...
				<h3>Esmerald</h3>
				<p>$1299</p>
				<div class="buybtn button"><a href="#">Buy</a></div>
				</div>
			</div>
		</div>
	</div>
